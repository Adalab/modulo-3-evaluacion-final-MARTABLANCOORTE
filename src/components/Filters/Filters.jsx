...
function Filters({filterGender,handleFilterCharacter, handleFilterStudent, handleResetFilters, handleFilterHouse, handleFilterGender}) {
    return (
      <form>
...
//filterGender, filterAlive, handleFilterAlive
//
